...
projectLocation = "C:/Users/vlads/Codes/Python/WebScrapingApps"

# adStatus is meant for checking if the data is correctly scraped so it could be used in the WebApp (in the future)
adStatus = open(f"{projectLocation}/CarAdvertismentStatistics/advertscrape/adverts/adverts_{today}_status.txt","w")
...
file = open(f"{projectLocation}/CarAdvertismentStatistics/advertscrape/adverts/adverts_{today}.json","w")
file.write("")
file.close()
...
os.chdir(f"{projectLocation}/CarAdvertismentStatistics/advertscrape")
os.system(f"scrapy crawl adverts_v2 -o adverts/adverts_{today}.json")

# import json file to variable 'data' and sort it
with open(f'{projectLocation}/CarAdvertismentStatistics/advertscrape/adverts/adverts_{today}.json', encoding='utf-8') as json_file:
...
# export sorted data
with open(f'{projectLocation}/CarAdvertismentStatistics/advertscrape/adverts/adverts_{today}.json', 'w', encoding='utf-8') as f:
