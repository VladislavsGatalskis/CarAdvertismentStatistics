...
projectLocation = "C:/Users/vlads/Desktop/LU/2.kurss/4.sem/Python/Codes"

# adStatus is meant for checking if the data is correctly scraped so it could be used in the WebApp (in the future)
adStatus = open(f"{projectLocation}/CarAdvertismentStatistics/advertscrape/adverts_{today}_status.txt","w")
...
file = open(f"{projectLocation}/CarAdvertismentStatistics/advertscrape/adverts_{today}.json","w")
file.write("")
file.close()
...
with open(f'{projectLocation}/CarAdvertismentStatistics/advertscrape/adverts_{today}.json', encoding='utf-8') as json_file:
...
# export sorted data
with open(f'{projectLocation}/CarAdvertismentStatistics/advertscrape/adverts_{today}.json', 'w', encoding='utf-8') as f:
